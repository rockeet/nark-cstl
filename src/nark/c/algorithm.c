...
void nark_update_heap(void* first, ptrdiff_t _IdxUpdated, ptrdiff_t count, ptrdiff_t elem_size, ptrdiff_t field_offset, field_type_t field_type)
{
...
void nark_update_heap_p(void* first, ptrdiff_t _IdxUpdated, ptrdiff_t count, ptrdiff_t field_offset, field_type_t field_type)
{
...
ptrdiff_t nark_equal_range(const void* first, ptrdiff_t count, ptrdiff_t elem_size, ptrdiff_t field_offset, field_type_t field_type, ptrdiff_t* upp, ...)
{
	field_type_t ft2 = internal_field_type(field_type);
...
ptrdiff_t nark_equal_range_p(const void* first, ptrdiff_t count, ptrdiff_t field_offset, field_type_t field_type, ptrdiff_t* upp, ...)
{
	field_type_t ft2 = internal_field_type(field_type);
...
void nark_arraycb_init(nark_arraycb* self, ptrdiff_t elem_size, ptrdiff_t field_offset, field_type_t field_type, int is_byptr)
{
	field_type_t ft2 = internal_field_type(field_type);
	check_args(elem_size, field_offset, field_type);
	if (is_byptr)
...
ptrdiff_t nark_acb_binary_search(const nark_arraycb* acb, const void* first, ptrdiff_t count, ...)
{
	ptrdiff_t ret;
	va_list key;
	va_start(key, count);
...
ptrdiff_t nark_acb_lower_bound(const nark_arraycb* acb, const void* first, ptrdiff_t count, ...)
{
	ptrdiff_t ret;
	va_list key;
	va_start(key, count);
...
ptrdiff_t nark_acb_upper_bound(const nark_arraycb* acb, const void* first, ptrdiff_t count, ...)
{
	ptrdiff_t ret;
	va_list key;
	va_start(key, count);
...
ptrdiff_t nark_acb_equal_range(const nark_arraycb* acb, const void* first, ptrdiff_t count, ptrdiff_t* upp, ...)
{
	ptrdiff_t ret;
	va_list key;
	va_start(key, upp);
